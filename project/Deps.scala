...
object Deps {
  ...
  // frp
  val colibri = s("com.github.cornerman" %%% "colibri" % "0.2.1")

  // rpc
  val sloth = s("com.github.cornerman" %%% "sloth" % "0.4.0")
  val chameleon = s("com.github.cornerman" %%% "chameleon" % "0.3.2")
  ...
  val sttp = new {
    ...
    val catsClient   = s("com.softwaremill.sttp.client3" %%% "catsce2" % "3.3.18")
  }
