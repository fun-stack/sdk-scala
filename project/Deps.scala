...
object Deps {
  ...
  // core libraries
  val cats = new {
    val effect = s("org.typelevel" %%% "cats-effect" % "3.5.1")
  }
  ...
  // rpc
  val sloth     = s("com.github.cornerman" %%% "sloth" % "0.7.0")
  val chameleon = s("com.github.cornerman" %%% "chameleon" % "0.3.6")
  ...
  val tapir = new {
    ...
    val catsClient = s("com.softwaremill.sttp.client3" %%% "cats" % "3.8.16")
  }
