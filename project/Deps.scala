...
object Deps {
  ...
  // rpc
  val sloth     = s("com.github.cornerman" %%% "sloth" % "0.7.2")
  val chameleon = s("com.github.cornerman" %%% "chameleon" % "0.3.8")
  ...
  val tapir = new {
    ...
    val catsClient = s("com.softwaremill.sttp.client3" %%% "cats" % "3.9.7")
  }
